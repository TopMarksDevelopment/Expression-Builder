...
public static partial class IQueryFilterable_TClass_IsNotNullOrWhiteSpaceExtensions
{
    ...
    public static IQueryFilterable<TClass> IsNotNullOrWhiteSpace<TClass, TPropertyType>(
    ...
    public static IQueryFilterableConnection<TClass> IsNotNullOrWhiteSpace<TClass, TPropertyType>(
        this IQueryFilterable<TClass> filter,
        Expression<Func<TClass, TPropertyType?>> propertyExpression,
        IFilterStatementOptions? options
    )
