...
public static partial class IFilter_TClass_IsNotNullOrWhiteSpaceExtensions
{
    ...
    public static IFilter<TClass> IsNotNullOrWhiteSpace<TClass, TPropertyType>(
    ...
    public static IFilterConnection<TClass> IsNotNullOrWhiteSpace<
        TClass,
        TPropertyType
    >(
        this IFilter<TClass> filter,
    ...
    public static IFilterConnection<TClass> IsNotNullOrWhiteSpace<
        TClass,
        TPropertyType
    >(this IFilter<TClass> filter, string propertyExpression)
        where TClass : class =>
        filter.Add<TPropertyType>(
            propertyExpression,
            new IsNotNullOrWhiteSpace(),
