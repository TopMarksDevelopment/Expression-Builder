...
public static partial class IFilterable_TClass_DoesNotStartWithExtensions
{
    ...
    public static IFilterable<TClass> DoesNotStartWith<TClass, TPropertyType>(
    ...
    public static IFilterableConnection<TClass> DoesNotStartWith<
        TClass,
        TPropertyType
    >(
        this IFilterable<TClass> filter,
    ...
    >(
        ...
        where TClass : class =>
        filter.Add(propertyExpression, new DoesNotStartWith(), [value]);
